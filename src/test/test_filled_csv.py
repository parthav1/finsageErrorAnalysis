...
# -------------csv_path-----------------
csv_path = "/root/autodl-tmp/dir_tzh/lotus_dataset/write_csv_json/blank.csv" # 要填的表
output_csv = "/root/autodl-tmp/dir_tzh/lotus_dataset/write_csv_json/test_result.csv"

# ---------- 把列表写成 JSON ----------
out_json_file = Path("/root/autodl-tmp/dir_tzh/lotus_dataset/write_csv_json/test_result.json")
