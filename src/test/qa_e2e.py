...
if __name__ == "__main__":
    ...
    questions_file = "multi_subquestion.md"
    ...
    for i in range(0, num_questions, BATCH_SIZE):
        ...
        for idx, item in enumerate(batch_questions):
            ...
            # Process question
            st_time = time.time()
            answer, rag_context, rag_info, rewritten_question, hypo_chunk_content, all_retrieved_content, history = chat_service.generate_response_with_rag(
            ...
            question_result["hypo_chunk_content"] = hypo_chunk_content
            ...
            #   chat_service.generate_chat_summary(session_id)  No need to generate summary
